...
update_kernel_patch() {
  ...
  case $KERNEL_VERSION in
      5*)
          RCN_PATCH_URL=http://rcn-ee.net/deb/bookworm-arm64/v$PATCH_VERSION/$ORIGINAL_DIFF_XZ
...
update_kernel_patch 5.10.120-ti-arm64-r59 5.10.120 0001-rcn-linux-5.10.120-ti-arm64-r59.patch
